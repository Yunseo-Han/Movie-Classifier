...
def main():
    print("Please enter your review path when prompt, for example D:\IdeaProjects\Movie-Classifier\hw4\Movie_Reviews\pos")
    pos = input("Enter your Positive Reviews path : ")
    neg = input("Enter your Negative Reviews path : ")
    pre_process(pos, neg)
